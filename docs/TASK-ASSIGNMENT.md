...
Antes de write código, leé completo el bloque de la regla de las exenciones
...
Antes de write el servicio de registro, leé las tres decisiones del paso 4 de
